...
public class DeleteApiCallJobCommandHandler : IRequestHandler<DeleteApiCallJobCommand>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUserService;
    private readonly IMessagePublisher _messagePublisher;

    public DeleteApiCallJobCommandHandler(IApplicationDbContext context, ICurrentUserService currentUserService, IMessagePublisher messagePublisher)
    {
        _context = context;
